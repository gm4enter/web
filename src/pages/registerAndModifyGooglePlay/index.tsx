...
const useStyles = makeStyles({
    container: {
        ...
        '&>div:nth-of-type(3)': {
            marginTop: '16px', padding: '24px', borderRadius: '12px', border: '1px solid #D0D5DD',
            '&>p': { padding: 0, margin: 0, fontSize: '16px', fontWeight: 500, },
        },
        '&>div:nth-of-type(4)': {
            marginTop: '16px',
            ...
            '&>p:nth-of-type(2)': { padding: 0, margin: '8px 0 0 0', fontSize: '14px', fontWeight: 400, },
        },
        '&>div:nth-of-type(5)': {
            marginTop: '16px',
            padding: '24px',
...
function RegisterAndModifyGooglePlay() {
    ...
    return (
        <div className={classes.container}>
            <div>
                <img src={iconBack} onClick={() => { navigate(-1) }} alt='' />
                <p>구글플레이 등록 및 수정</p>
            </div>
            ...
            <div>
                ...
                <Input
                    ...
                    isCountValueLength
                    placeholder='입력해주세요.'
                    onChange={(e) => { setInputValueNameApp(e.target.value) }}
                    containerStyle={{ width: 'calc(50% + 32px)', marginTop: '20px', }}
            ...
            <div>
                ...
                <div>
                    ...
                    <p style={{}}>*알림 아이콘은 앱에서 알림이 왔을때 상단에 보여지는 아이콘입니다.</p>
                </div>

                <button onClick={() => { navigate(ROUTE.SITELISTANDEXPIREDLIST) }} style={{}}>
                    <p style={{}}>제출하기</p>
                </button>
            </div>
        </div>
